...
public class OGCFeatEPSG3067DataStoreFactoryTest {

	public static void main(String[] args)
			throws MalformedURLException, IOException, NoSuchAuthorityCodeException, FactoryException {

		String requestCRS = "http://www.opengis.net/def/crs/EPSG/0/3067";
		...
		try {
			...
			// double[] bbox = new double[] { 24.46526138302816, 60.2596073383277,
			// 24.521212182443456, 60.27770378913576 };

			double[] bbox = { 360230.57833327126, 6683424.259906484, 362728.9040402942, 6685162.590734564 };
			...
			OGCFeatFeatureSource fs = (OGCFeatFeatureSource) datastore.getFeatureSource("soistuma");
